...
本章趋势与主题统计基于 2026-08-10 分析快照(168{,}447 条); 讯飞增量(5{,}566 篇, 多为生物医学预印本)未重跑趋势管线, 对 RAG/LLM 等计算机方向热点的排序无实质影响。
\end{reportbox}
...
\begin{methodnote}
2026 年需要单独解释: 截至 2026-08-10 分析快照, 该年度尚未结束, 且新近论文的关键词和索引记录存在更新滞后。报告主图已使用显式关键词与题名摘要术语的融合信号进行修正, 2026 年融合信号比单看显式关键词增加约 22.7\%; 因此 2026 年只作为未完整年度的早期信号, 不与完整年度作机械对比。
\end{methodnote}
