...
\item PubMed / PubMed Central (PMC) —— 美国国立医学图书馆生物医学文献库。\url{https://pubmed.ncbi.nlm.nih.gov}
...
\item Model Context Protocol documentation. Open-source standard for connecting AI applications to external systems, tools and workflows. \texttt{https://modelcontextprotocol.io/docs/getting-started/intro}
\end{enumerate}
