...
\node[layer, text width=150mm] (proc) at (78,22) {清洗规范化 · \textbf{标题优先去重} · front-matter/PDF 垃圾过滤 · NUL 清洗 → 159{,}164 篇六源语料 + 5{,}566 篇讯飞交付包语料(\texttt{processed})};
...
\textbf{数据组织与治理} → 规范化字段;标题优先去重(合并跨源/预印本同篇,留最全一条)+ front-matter 剔除 + PDF 垃圾/ NUL 清洗;168{,}447 条分析语料进一步形成 159{,}164 篇处理后语料文件,另讯飞交付包 5{,}566 篇经同一治理链入库,运行时库表当前装载 164{,}730 篇论文与 413{,}971 个片段。\\
