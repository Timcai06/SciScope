...
\texttt{chunk\_embeddings=367{,}861/367{,}861}、\texttt{paper\_embeddings=159{,}164/159{,}164} 与 ANN 索引; 本机报告构建与接口调试可不携带这组全量资产。公开托管后端为 demo-lite 子集,不能替代本地/自建全量部署的能力证明。
\end{plainbox}
