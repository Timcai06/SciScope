...
- 当前领取：E07 技术材料与预检已完成；待录制正式视频并由非技术队友计时验收，通过后再进入 E09；上游：[冻结目标说明书](../../project/国赛目标说明书.md)
...
- 状态：`技术准备 PASS / 视频与非技术评委验收 PENDING`；依赖：E03、E04、T04 已满足。T04 工程证据见
  [T04 远端全量演练与离线回退](T/T04-20260812-远端全量演练与离线回退.md)。
...
- 当前产物：[E07 评委演示材料与人工门禁](E/E07-20260812-评委演示材料与人工门禁.md)、
  `docs/operations/judge-demo-runbook.md` 与 `output/evidence/e07/preflight.{json,md}`。
...
- 状态：`LOCKED（等待 E07 人工门禁）`；依赖：E02、E03、E04、E06、E07，若主张讯飞场景还依赖 E08。
...
| E07 | `技术准备 PASS / 人工 PENDING` | [E07 演示材料与人工门禁](E/E07-20260812-评委演示材料与人工门禁.md)：自动预检 8 PASS/0 FAIL；待两份视频和非技术评委计时验收 |
| E08 | `BLOCKED` | 授权、准入与真实场景/反馈 |
| E09 | `LOCKED` | 等待 E07 视频与非技术评委验收 PASS 后，提交包与独立复现记录 |
